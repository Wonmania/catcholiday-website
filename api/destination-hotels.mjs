...
const destinations = new Map([
  ...
  ['sigacikin-en-iyi-10-oteli', 'Sığacık, Seferihisar, İzmir'],
  ['seferihisarin-en-iyi-10-oteli', 'Seferihisar, İzmir'],
  ['focanin-en-iyi-10-oteli', 'Foça, İzmir'],
  ['ozderenin-en-iyi-10-oteli', 'Özdere, Menderes, İzmir'],
  ['gumuldurun-en-iyi-10-oteli', 'Gümüldür, Menderes, İzmir'],
  ['selcukun-en-iyi-10-oteli', 'Selçuk, İzmir'],
  ['pamucakin-en-iyi-10-oteli', 'Pamucak, Selçuk, İzmir'],
  ['ayvalikin-en-iyi-10-oteli', 'Ayvalık, Balıkesir'],
  ['cunda-adasinin-en-iyi-10-oteli', 'Cunda Adası, Ayvalık, Balıkesir'],
  ['altinolukun-en-iyi-10-oteli', 'Altınoluk, Edremit, Balıkesir'],
  ['akcayin-en-iyi-10-oteli', 'Akçay, Edremit, Balıkesir'],
  ['gurenin-en-iyi-10-oteli', 'Güre, Edremit, Balıkesir'],
  ['bozcaadanin-en-iyi-10-oteli', 'Bozcaada, Çanakkale'],
  ['gokceadanin-en-iyi-10-oteli', 'Gökçeada, Çanakkale'],
  ['akyakanin-en-iyi-10-oteli', 'Akyaka, Ula, Muğla'],
  ['datcanin-en-iyi-10-oteli', 'Datça, Muğla'],
  ['palamutbukunun-en-iyi-10-oteli', 'Palamutbükü, Datça, Muğla'],
  ['eski-datcanin-en-iyi-10-oteli', 'Eski Datça, Muğla'],
  ['pamukkalenin-en-iyi-10-oteli', 'Pamukkale, Denizli'],
  ['uchisarin-en-iyi-10-oteli', 'Uçhisar, Nevşehir'],
  ['avanosun-en-iyi-10-oteli', 'Avanos, Nevşehir'],
  ['ortahisarin-en-iyi-10-oteli', 'Ortahisar, Ürgüp, Nevşehir'],
